...
class InformationThree extends InformationEvent {
  ...
  InformationThree({@required this.genderType});
  @override
...
class InformationSix extends InformationEvent {
  ...
  InformationSix({@required this.activityType});
  @override
  List<Object> get props => [activityType];
}
class InformationType extends InformationEvent {
  final String goalType;

  InformationType({@required this.goalType});
  @override
